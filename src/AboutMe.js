    ...
    <div style={{ display: "flex", height: "100vh", position: "relative" }}>
      ...
      <div style={{ flex: 1, display: "flex", justifyContent: "center", alignItems: "center", padding: "50px", position: "relative", zIndex: 1, color: "white" }}>
        <div style={{ padding: "30px", backgroundColor: "rgba(255, 255, 255, 0.9)", borderRadius: "12px", textAlign: "center", maxWidth: "900px", color: "#333" }}>
          <h1 style={{ color: "#1e3a8a" }}>About Me</h1>
          <p>Hi, I'm Carl Derick Pimentel. I'm 19 years old and passionate about building and assembling computers.</p>
          <p>I love studying and gaining knowledge about technology. In my free time, I enjoy playing video games like Dragon Nest and Valorant.</p>
          <p>Besides gaming, I love movies and music. They help me relax and stay inspired.</p>
        </div>
      </div>
    </div>
  );
